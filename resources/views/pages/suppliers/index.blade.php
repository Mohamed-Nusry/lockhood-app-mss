    ...
    <div class="container-fluid">
        @if(Auth::user()->user_type != null)
            ...
            @else
                ...
                <button disabled class="btn btn-primary mt-2 btn-create mr-2" style="float:right">Add New Supplier</button>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" onclick="$('.supplier-modal').modal('toggle');" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <form name="supplier-form" id="supplier-form">
                    ...
                    <div class="modal-footer">
                        <button type="button" onclick="$('.supplier-modal').modal('toggle');" class="btn btn-secondary" data-dismiss="modal">Close</button>
