        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" onclick="$('.material-modal').modal('toggle');" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <form name="material-form" id="material-form">
                    ...
                    <div class="modal-footer">
                        <button type="button" onclick="$('.material-modal').modal('toggle');" class="btn btn-secondary" data-dismiss="modal">Close</button>
