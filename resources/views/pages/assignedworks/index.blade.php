    ...
    <div class="container-fluid">
        @if(Auth::user()->user_type != null)
            ...
            @else
                ...
                <button disabled class="btn btn-primary mt-2 btn-create mr-2" style="float:right">Create Work</button>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" onclick="$('.assignedwork-modal').modal('toggle');" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <form name="assignedwork-form" id="assignedwork-form">
                    ...
                    <div class="modal-footer">
                        <button type="button" onclick="$('.assignedwork-modal').modal('toggle');" class="btn btn-secondary" data-dismiss="modal">Close</button>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#table-assignedwork').on('click', '.btn-delete', function(event){
             ...
             $('#table-assignedwork').on('click', '.btn-ongoing', function(event){
                event.preventDefault();
                const id       = $(this).data('id');
                const name     = $(this).data('name');
                const status     = 2;
            ...
            $('#table-assignedwork').on('click', '.btn-complete', function(event){
                event.preventDefault();
                const id       = $(this).data('id');
                const name     = $(this).data('name');
                const status     = 3;
